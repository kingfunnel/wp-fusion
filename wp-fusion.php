...
define( 'WP_FUSION_VERSION', '3.38.27' );
...
final class WP_Fusion {
	...
	public function full_version_notice() {
		...
		echo '<div class="notice notice-error">';
		echo '<p>';
		esc_html_e( 'Warning: It looks like the full version of WP Fusion has been installed. Please deactivate the WP Fusion Lite plugin.', 'wp-fusion' );
		echo '</p>';
		echo '</div>';
