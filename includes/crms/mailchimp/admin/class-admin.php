	...
	public function register_connection_settings( $settings, $options ) {
		...
		if ( $settings['connection_configured'] && wpf_get_option( 'crm' ) === $this->slug ) {
			...
			$new_settings['mc_default_list'] = array(
				...
				'desc'        => __( 'Select an audience to use for WP Fusion. If you change the audience, you\'ll need to click Refresh Available Tags & Fields (above) to update the available dropdown options.', 'wp-fusion' ),
				'type'        => 'select',
