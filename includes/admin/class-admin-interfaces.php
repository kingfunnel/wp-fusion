...
class WPF_Admin_Interfaces {
			...
			<tbody>
				...
				<tr class="form-field">
					...
					<td>
						...
						<span class="description"><?php printf( esc_html__( 'Apply these restrictions to all posts in the %1$s %2$s.', 'wp-fusion' ), $term->name, $taxonomy->labels->singular_name ); ?></p>
					</td>
				</tr>
				...
				<tr class="form-field">
					...
					<td>
						...
						<span class="description"><?php esc_html_e( 'The taxonomy term will be completely hidden from all term listings. (Note that this just hides the term itself. To completely hide all restricted posts enable Filter Queries in the WP Fusion settings)', 'wp-fusion' ); ?></p>
					</td>
				</tr>
	...
	public function admin_menu_fields( $item_id, $item, $depth, $args, $id = false ) {
		...
		<div class="wpf_nav_menu_tags_field description-wide" style="margin: 5px 0; <?php echo $hidden; ?>">
			<p class="description description-wide"><?php esc_html_e( 'Required tags (any)', 'wp-fusion' ); ?>:</p>
			<br />
