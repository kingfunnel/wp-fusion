...
class WPF_User_Profile {
	...
	public function user_profile( $user ) {
		...
		?>
		<h3><?php esc_html_e( 'WP Fusion', 'wp-fusion' ); ?></h3>
		...
		<table class="form-table">
			...
			<tr>
				...
				<td>
					...
					<p class="description"><?php echo sprintf( __( 'If the contact ID or tags aren\'t in sync, click here to reset the local data and load from the %s contact record.', 'wp-fusion' ), esc_html( wp_fusion()->crm->name ) ); ?></p>
